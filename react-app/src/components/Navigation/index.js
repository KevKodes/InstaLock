      ...
      <nav className="liner">
        ...
        <ul id="nav">
          ...
          <li>
            {/* Added className navIcon */}
            <div className="tooltip">
              <NavLink id="ez2" to="/" exact={true} className="navIcon" activeClassName="active"></NavLink>
          ...
          <li>
            {/* Added className navIcon */}
            <div className="tooltip">
              <NavLink id="ez3" to="/upload" exact={true} className="navIcon" activeClassName="active"></NavLink>
              <span class="tooltiptext2">Upload</span>
            </div>
          </li>
          <li>
            {/* Added className navIcon*/}
            <div className="tooltip">
              <NavLink id="ez5" to={`/${userName}`} exact={true} className="navIcon" activeClassName="active"></NavLink>
